...
class MqttMessageHandler:
    ...
    #         logger.error(
    #             "Invalid eq_manager. Expected EquipmentManager, got %s.", type(eq_manager))
    #         client.publish("equipment/error/mqtt",
    #                        "Invalid equipment manager.")
    #         return
    ...
    #     if equipment:
    #         rsp_topic_control = "equipments/control/response/" + machine_name + "/" + command
    ...
    def handle_control_command(self, client: mqtt.Client, eq_manager, message: mqtt.MQTTMessage, topic_parts):
    ...
    def handle_config_command(self, client: mqtt.Client, eq_manager, message: mqtt.MQTTMessage, topic_parts):
        from src.core.equipment_manager import EquipmentManager
        # Ensure user data is set correctly and includes "equipments"
        if not isinstance(eq_manager, EquipmentManager):
            logger.error(
