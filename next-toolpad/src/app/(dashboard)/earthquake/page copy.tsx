                        ...
                        <Grid2 size={4} key={quake.properties.dateTimeUTC}>
                            ...
                            >
                                <CardContent>
                                    ...
                                    <Box mt={1}>
                                        <Link
                                            href={`https://maps.google.com/?q=${quake.properties.latitude},${quake.properties.longitude}`}
                                            target="_blank"
                        ...
                        <Grid2 size={4} key={quake.id}>
                            <Card
                                ...
                                <CardContent>
                                    ...
                                    <Typography variant="body2">Time: {quakeTime}</Typography>
                                    <Typography variant="body2">Updated: {updatedTime}</Typography>
                                    <Typography variant="body2">Depth: {quake.geometry.coordinates[2]} km  lon: {quake.geometry.coordinates[0]}, lat:{quake.geometry.coordinates[1]}</Typography> */}
                                    <Typography variant="body1">📌 {quake.properties.place}</Typography>
                                    <Typography variant="body2">📅 {quakeTime}</Typography>
                                    <Typography variant="body2">🌍 {quake.geometry.coordinates[2]} km. </Typography>
                                    ...
                                    <Box mt={1}>
                                        <Link
                                            href={`https://maps.google.com/?q=${quake.geometry.coordinates[1]},${quake.geometry.coordinates[0]}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                        // underline="hover"
                                        >
                        ...
                        <Grid2 size={4} key={quake.id}>
                            <Card
                                ...
                                <CardContent>
                                    ...
                                    <Typography variant="body2">Time: {quakeTime}</Typography>
                                    <Typography variant="body2">Updated: {updatedTime}</Typography>
                                    <Typography variant="body2">Depth: {quake.properties.depth} km,
                                        lon: {quake.geometry.coordinates[0]}, lat:{quake.geometry.coordinates[1]}</Typography> */}
