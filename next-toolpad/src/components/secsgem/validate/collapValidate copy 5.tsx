                                                                            ...
                                                                            {config.data_with_selection_code.map((dataItem, dataItemIndex) => {
                                                                                ...
                                                                                return (
                                                                                    <React.Fragment key={dataItemIndex}>
                                                                                        {/* Level 2: Data Item */}
                                                                                        <Box pl={0} sx={{ mb: 1, display: 'block', alignItems: 'center', width: '100%', borderBottom: '1px solid rgba(224, 224, 224, 0.5)' }}>
                                                                                            {/* <IconButton
                                                                                                size="small"
                                                                                                onClick={() => toggleExpand(dataItemKey, 'package_selection_code')} // เรียกใช้ toggleExpand สำหรับ package_selection_code level
                                                                                            >
