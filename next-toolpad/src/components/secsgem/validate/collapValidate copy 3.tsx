...
export default function CollapValidate() {
    ...
    const toggleExpand = (id: string, dataIndex: number, configIndex: number) => {
    ...
    const toggleExpandDataItem = (id: string, dataIndex: number, configIndex: number, dataItemIndex: number) => {
        const key = `${dataIndex}-${configIndex}-${dataItemIndex}`;
        setExpandedDataItem(prev => (prev === key ? null : key));
        console.log("toggleExpandDataItem Id:", id);
                                                    ...
                                                    <React.Fragment key={configIndex}>
                                                        ...
                                                        <TableRow>
                                                            <TableCell>
                                                                <IconButton
                                                                    size="small"
                                                                    onClick={() => toggleExpand(data._id, dataIndex, configIndex)}
                                                                >
                                                                            ...
                                                                            return (
                                                                                <React.Fragment key={dataItemIndex}>
                                                                                    ...
                                                                                    <Box pl={4} sx={{ mb: 1, display: 'flex', alignItems: 'center', width: '100%', borderBottom: '1px solid rgba(224, 224, 224, 0.5)' }}>
                                                                                        <IconButton size="small" onClick={() => toggleExpandDataItem(data._id, dataIndex, configIndex, dataItemIndex)}>
