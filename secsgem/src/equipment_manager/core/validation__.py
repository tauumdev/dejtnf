    ...
    def get_lot_info(
        ...
        for attempt in range(max_retries):
            try:
                ...
                print(f"API request failed (attempt {
...
#     # Get lot information
#     result = api_client.get_lot_info(["PPPP0101.1"])

#     if result:
#         print("API Response:")
#         print(json.dumps(result, indent=2))
#     else:
#         print("Failed to retrieve lot information")
...
class LotInformation:
    ...
    def _load_data(self):
        try:
            with open('secsgem/files/lotdetail.json', 'r', encoding='utf-8') as file:
...
#     lot_info = LotInformation("LOT-001")
